...
\begin{figure} [H]%
	\centering
	\subfloat[Dog bark]{{\includegraphics[width=7.5cm]{../plots/dog_bark_comp.png}}}
	\subfloat[Jackhammer]{{\includegraphics[width=7.5cm]{../plots/jackhammer_comp.png}}}
...
\begin{figure} [H]%
	\centering
	\subfloat[Jackhammer]{{\includegraphics[width=7.5cm]{../plots/jackhammer_comp2.png}}}
	\subfloat[Drilling]{{\includegraphics[width=7.5cm]{../plots/drilling_comp2.png}}}
