...
\end{equation}
In the latter equation we can easily see why this solves our problem. For this case, we expect the coefficients to be smaller compared with OLS, since the cost function is directly dependent of $\vec{\beta}^2$.
...
\end{equation}
We expect the coefficients to be even smaller for Lasso regression then for Ridge regression, since the cost function is directly dependent of $\vec{\beta}$.
