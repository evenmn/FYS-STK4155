...
\begin{figure} [H]%
	\centering
	\subfloat[Lambda vs. R2-score]{{\includegraphics[width=8cm]{../plots/lambda_R2score.png} }}%
	\subfloat[Variance vs. R2-score]{{\includegraphics[width=8cm]{../plots/var_R2score.png} }}
	\caption{}%
	\label{fig:R2_scores}
\end{figure}
