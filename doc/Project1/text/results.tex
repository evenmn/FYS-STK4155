...
\begin{figure} [H]%
	\centering
	\subfloat[OLS terrain]{{\includegraphics[width=9cm]{../plots/OLS_terrain.png} }}%
	\subfloat[Ridge terrain]{{\includegraphics[width=9cm]{../plots/Ridge_terrain.png} }}\\
	
	\subfloat[Lasso terrain]{{\includegraphics[width=9cm]{../plots/Lasso_terrain.png} }}%
	\subfloat[Lombok]{{\includegraphics[width=9cm]{../plots/lombok.png} }}
